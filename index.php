...
<body>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/demo.jpg);">
    ...
    <div class="container">
      ...
      <div class="row mt-5">
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/ashish.jpg" class="img-fluid" style="border-radius: 100px;">
              <h4 class="card-title">Ashish Suthar</h4>
              <p class="card-text">"Excellent customer service is the number one job in any company! It is the personality of the company and the reason customers come back. Without customers there is no company!".</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/ravi.JPG" class="img-fluid" style="border-radius: 100px;">
              <h4 class="card-title">Ravi Upadhyay</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/prabhat.JPG" class="img-fluid" style="border-radius: 100px;">
              <h4 class="card-title">Prabhat upadhyay</h4>
              <p class="card-text">"The key is when a customer walks away, thinking, 'Wow, I love doing business with them, and I want to tell others about the experience.'"</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/rahul.JPG" class="img-fluid" style="border-radius: 100px;">
              <h4 class="card-title">Rahul Tandel</h4>
              <p class="card-text">"The sole reason we are in business is to make life less difficult for our clients."</p>
            </div>
          </div>
